...
struct qt_meta_stringdata_UpyunClient_t {
    QByteArrayData data[6];
    char stringdata[59];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_UpyunClient_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_UpyunClient_t qt_meta_stringdata_UpyunClient = {
    {
...
QT_MOC_LITERAL(5, 47, 10)
    ...
    "UpyunClient\0notifyStop\0\0progress\0"
    "bytesFinished\0bytesTotal\0"
};
...
void UpyunClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (UpyunClient::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UpyunClient::notifyStop)) {
                *result = 0;
            }
        }
        {
            typedef void (UpyunClient::*_t)(qint64 , qint64 );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UpyunClient::progress)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject UpyunClient::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UpyunClient.data,
      qt_meta_data_UpyunClient,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UpyunClient.stringdata))
